...
Custom license — private use and modification for personal use are allowed. Redistribution and commercial use are reserved to the copyright holder. See [LICENSE](LICENSE) for full terms.
